...
<style scoped>
.control-card, .layer-card, .attr-card, .stock-chain-card, .result-card, .log-card {
  background: hsl(224 25% 13%);
  border: 1px solid hsl(220 20% 20%);
  border-radius: 8px;
  padding: 16px;
}
.control-left { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; }
.title { font-size: 14px; font-weight: bold; margin-right: 16px; color: hsl(210 20% 92%); }
.layer-title { font-size: 14px; font-weight: bold; margin-bottom: 12px; color: hsl(210 20% 92%); }
.chart-container { width: 100%; height: 420px; }
.chart-title { font-size: 14px; font-weight: bold; margin-bottom: 12px; color: hsl(210 20% 92%); }
.log-content {
  height: 360px; overflow-y: auto;
  border: 1px solid hsl(220 20% 20%); border-radius: 6px; padding: 10px;
  background: hsl(228 35% 7%);
}
.log-item { margin-bottom: 8px; font-size: 12px; line-height: 1.6; padding-bottom: 8px; border-bottom: 1px solid hsl(220 20% 20% / 0.5); }
.log-item.system { color: hsl(190 100% 50%); }
.log-item.policy { color: hsl(220 80% 65%); }
.log-item.game { color: hsl(38 100% 55%); }
.log-item.sentiment { color: hsl(280 80% 70%); }
.log-item.capital { color: hsl(0 88% 64%); }
.log-item.geo { color: hsl(210 20% 92%); }
.log-item.success { color: hsl(149 100% 44%); font-weight: bold; }
.log-item.error { color: hsl(0 80% 55%); }
.log-item .time { color: hsl(215 14% 45%); margin-right: 6px; font-family: 'JetBrains Mono', monospace; font-size: 10px; }
.empty-tip { text-align: center; color: hsl(215 14% 45%); font-size: 12px; padding: 20px 0; }
.attr-content, .result-text { font-size: 13px; color: hsl(210 20% 92%); line-height: 1.8; }
