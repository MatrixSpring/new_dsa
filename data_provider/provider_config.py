...
PROVIDER_PRIORITY = {
    ...
    "stock_sentiment": parse_source_priority("PRIORITY_SENTIMENT", "efinance,akshare"),
    "stock_news": parse_source_priority("PRIORITY_NEWS", "akshare,tushare"),
}
